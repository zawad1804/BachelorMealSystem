...
// Fetch payment summary with balance and approved payments
$summary_query = "SELECT 
    COALESCE(u.balance, 0) as meal_cost,
...
$payment_query = "SELECT * FROM payments WHERE user_id = ? ORDER BY payment_date DESC";
